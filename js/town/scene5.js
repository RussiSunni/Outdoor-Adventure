            ...
            function () {
                if (this.bgNum == 0) {
                    if (this.textNum == 0) {
                        ...
                        this.charDialogue.setText('They cost $100. How much do you have?')
                        this.textNum = 3;
                    }
                        ...
                        this.speechOption1Text = this.add.text(20, 15, "$100", { fontFamily: 'Arial', fill: '#ffffff', fontSize: 40, wordWrap: { width: this.sys.canvas.width - 15, useAdvancedWrap: true } });
